...
const routes = [
    { path: '/login', component: Login, meta: { guest: true } },
    {
        ...
        children: [
            ...
            { path: 'product-movements', component: () => import('./views/ProductMovements.vue'), meta: { roles: ['admin', 'courier'] } },
            { path: 'product-states', component: () => import('./views/ProductStates.vue'), meta: { roles: ['admin', 'courier'] } },
